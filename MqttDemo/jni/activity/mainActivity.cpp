...
static ZKButton* mSubscribeButtonPtr;
static ZKButton* mPublishButtonPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_SubscribeButton, onButtonClick_SubscribeButton,
    ID_MAIN_PublishButton, onButtonClick_PublishButton,
...
void mainActivity::onCreate() {
    ...
    mSubscribeButtonPtr = (ZKButton*)findControlByID(ID_MAIN_SubscribeButton);
    mPublishButtonPtr = (ZKButton*)findControlByID(ID_MAIN_PublishButton);
